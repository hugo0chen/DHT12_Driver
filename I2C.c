...
void I2C_SDAMode(uint8_t Mode)
{
	...
	{GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;	
		GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;   GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_DOWN;
	}
...
uint8_t I2C_WaiteForAck(void)
{
	...
	I2C_SCL_Clr();
	I2C_SDA_Set();
	I2C_SDAMode(I2C_SDA_IN);      //SDA设置为输入  
	Delay_us(14);	   
	I2C_SCL_Set();
	Delay_us(14);	 
	while(I2C_SDA_Get())//等到SDA变低
	{
		retryTime++;
		if(retryTime>250)
		{
...
/**
  ...
  *         
  * @retval  1: writen one bit succeed
**/
...
/**
  ...
  * @retval  0: paramter error
  *                1: Write a buffer succeed
**/
